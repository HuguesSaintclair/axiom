                                    ...
                                    <?php
                                        ...
                                        while ($row=mysqli_fetch_assoc($result)) 
                                        {
                                            ...
                                            $da=mysqli_fetch_assoc($resul);
                                             echo '<td>'.$da["date"].'</td>';
                                          ?>
                                          <td><button data-toggle="tooltip" title="Aperçu" class="pd-setting-ed"><a href="home_eleve.php?page=apercu_exercice&exo=<?=$id_exo ?>"><i class="fa fa-eye" style="color:blue" aria-hidden="true"></i></a></button></td>
                                          </tr>
                                        <?php
                                        }
                                    ?>
