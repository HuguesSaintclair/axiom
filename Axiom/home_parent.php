                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle interface-mini-nb-dp" aria-expanded="false">
                                <li><a title="Landing Page" href="all-students.html" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Enfants</span></a></li>
                        ...
                        <li>
                            <a title="Landing Page" href="notifications.html"><span class="educate-icon educate-apps icon-wrap"></span> <span class="mini-click-non">Forum</span></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Enfants</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="single-cards-item">
                                    ...
                                    <div class="single-product-text">
                                       ...
                                       <h5><a class="cards-hd-dn" href="#"><?php echo $row['classe']; ?></a></h5>
                                        ...
                                        <a class="follow-cards" href="#">Accéder</a>
                                    </div>
                                </div>
                            </div>
    <?php
